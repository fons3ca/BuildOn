...
namespace FirstREST.Lib_Primavera
{
    public class PriIntegration
    {
        ...
        public const string baseDados = "BUILDONDEM";
        # region Cliente
        ...
        public static List<Model.Cliente> ListaClientes()
        {
            ...
            if (PriEngine.InitializeCompany(baseDados, "", "") == true)
            {
                ...
                objList = PriEngine.Engine.Consulta("SELECT Cliente, Nome, NumContrib as NumContribuinte, B2BEnderecoMail as Email, Fac_Mor as Morada, Fac_Local as Localidade, Fac_Cploc as Freguesia, Fac_Cp as CodPostal, Fac_Tel as Telefone, Moeda FROM  CLIENTES");
                ...
                while (!objList.NoFim())
                {
                    listClientes.Add(new Model.Cliente
                    {
                        ...
                        Freguesia = objList.Valor("Freguesia"),
        ...
        public static Lib_Primavera.Model.Cliente GetCliente(string codCliente)
        {
            ...
            if (PriEngine.InitializeCompany(baseDados, "", "") == true)
            {
                ...
                if (PriEngine.Engine.Comercial.Clientes.Existe(codCliente) == true)
                {
                    ...
                    myCli.Freguesia = objCli.get_LocalidadeCodigoPostal();
            ...
            try
            {
                ...
                if (PriEngine.InitializeCompany(baseDados, "", "") == true)
                {
                    ...
                    else
                    {
                        ...
                        objCli.set_LocalidadeCodigoPostal(cliente.Freguesia);
        ...
        public static Lib_Primavera.Model.RespostaErro InsereClienteObj(Model.Cliente cli)
        {
            ...
            try
            {
                if (PriEngine.InitializeCompany(baseDados, "", "") == true)
                {
                    ...
                    //myCli.set_LocalidadeCodigoPostal(cli.Freguesia);
        ...
        public static List<Model.Artigo> ListaArtigos()
        {
            ...
            if (PriEngine.InitializeCompany(baseDados, "", "") == true)
            {
               ...
               // objList = PriEngine.Engine.Comercial.Artigos.LstArtigos();
                ...
                objList = PriEngine.Engine.Consulta("SELECT Artigo, Descricao, Observacoes, Marca, Familia, SubFamilia, STKActual FROM  ARTIGO");
                ...
                while (!objList.NoFim())
                {
                    ...
                    art.qtdStock = objList.Valor("STKActual");
